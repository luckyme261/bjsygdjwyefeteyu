#!/bin/bash
echo "🚀 V6.4.4: IDrive e2 Multi-Account Union Bootloader & Automation Core (Zsh Optimized)"
...
# ==========================================
# 2. CLOUDFLARED & SSH SETUP (Restored Old Working Logic)
# ==========================================
...
# Install the tunnel back exactly as a system service wrapper
